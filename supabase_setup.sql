...
-- Asset Track Database - Full Setup
-- ================================================================================
-- 
-- คำแนะนำการใช้งาน:
-- 1. เปิด Supabase Dashboard
-- 2. ไปที่ SQL Editor
-- 3. คัดลอกและรันไฟล์นี้ทีละส่วน หรือรันทั้งหมด
-- 
-- หรือใช้ Supabase CLI:
-- supabase db reset
-- psql <connection_string> < supabase_setup.sql
-- ================================================================================
...
-- ================================================================================
-- PART 3: Indexes for better performance
-- ================================================================================
...
-- Note: Categories and Assets data should be imported from insert_statements_supabase.sql
...
-- ================================================================================
-- 
-- ต่อไป: รันไฟล์ insert_statements_supabase.sql เพื่อเพิ่มข้อมูลหมวดหมู่และครุภัณฑ์
-- ================================================================================
