...
const InventoryCycleManager = ({ user, onCycleSelect, onViewChange })=>{
    ...
    const fetchData = async ()=>{
        ...
        try {
            const [cyclesResult, usersResult] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchInventoryCycles"](),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchUsers"]()
            ]);
    ...
    const handleCreateCycle = async ()=>{
        ...
        try {
            const assets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAssets"]();
            if (!assets || assets.length === 0) {
                setError('ไม่พบทรัพย์สินในระบบ กรุณาเพิ่มทรัพย์สินก่อนสร้างรอบการตรวจนับ');
                return;
            }
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createInventoryCycle"]({
                ...formData,
                status: 'Planning',
                created_by: user.id,
                assets: assets
    ...
    const handleUpdateCycle = async ()=>{
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateInventoryCycle"](editingCycle.id, formData);
            if (result.status === 'success') {
    ...
    const handleDeleteCycle = async (cycleId)=>{
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteInventoryCycle"](cycleId);
            if (result.status === 'success') {
    ...
    const handleStartCycle = async (cycleId)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateInventoryCycle"](cycleId, {
                status: 'In Progress'
            });
            if (result.status === 'success') {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    cycle.assigned_to && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center gap-2 text-sm text-slate-600",
                                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    cycle.status === 'Planning' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    cycle.status === 'In Progress' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__afa977de._.js.map